...
def main(args):
    ...
    cuts_sr1_alljet = list()
    cuts_sr1_alljet.append(("SR1+VBFVeto BB (all jets)", "Cut2TagMllSR1VBFVetoBBAllJet"))
    cuts_sr1_alljet.append(("SR1+VBFVeto BC (all jets)", "Cut2TagMllSR1VBFVetoBCAllJet"))
    cuts_sr1_alljet.append(("SR1+VBFVeto BL (all jets)", "Cut2TagMllSR1VBFVetoBLAllJet"))
    cuts_sr1_alljet.append(("SR1+VBFVeto CC (all jets)", "Cut2TagMllSR1VBFVetoCCAllJet"))
    cuts_sr1_alljet.append(("SR1+VBFVeto CL (all jets)", "Cut2TagMllSR1VBFVetoCLAllJet"))
    cuts_sr1_alljet.append(("SR1+VBFVeto LL (all jets)", "Cut2TagMllSR1VBFVetoLLAllJet"))
    cuts_sr1_alljet.append(("SR1+VBFVeto Total", "Cut2TagMllSR1VBFVeto"))
    cut_versions.append(cuts_sr1_alljet)
    ...
    cuts_sr2_alljet = list()
    cuts_sr2_alljet.append(("SR2 BB (all jets)", "Cut2TagMbbSR2BBAllJet"))
    cuts_sr2_alljet.append(("SR2 BC (all jets)", "Cut2TagMbbSR2BCAllJet"))
    cuts_sr2_alljet.append(("SR2 BL (all jets)", "Cut2TagMbbSR2BLAllJet"))
    cuts_sr2_alljet.append(("SR2 CC (all jets)", "Cut2TagMbbSR2CCAllJet"))
    cuts_sr2_alljet.append(("SR2 CL (all jets)", "Cut2TagMbbSR2CLAllJet"))
    cuts_sr2_alljet.append(("SR2 LL (all jets)", "Cut2TagMbbSR2LLAllJet"))
    cuts_sr2_alljet.append(("SR2 Total", "Cut2TagMbbSR2"))
    cut_versions.append(cuts_sr2_alljet)
    ...
    cuts_zllcr_alljet = list()
    cuts_zllcr_alljet.append(("ZllCR BB (all jets)", "Cut2TagMbbZllCRBBAllJet"))
    cuts_zllcr_alljet.append(("ZllCR BC (all jets)", "Cut2TagMbbZllCRBCAllJet"))
    cuts_zllcr_alljet.append(("ZllCR BL (all jets)", "Cut2TagMbbZllCRBLAllJet"))
    cuts_zllcr_alljet.append(("ZllCR CC (all jets)", "Cut2TagMbbZllCRCCAllJet"))
    cuts_zllcr_alljet.append(("ZllCR CL (all jets)", "Cut2TagMbbZllCRCLAllJet"))
    cuts_zllcr_alljet.append(("ZllCR LL (all jets)", "Cut2TagMbbZllCRLLAllJet"))
    cuts_zllcr_alljet.append(("ZllCR Total", "Cut2TagMbbZllCR"))
    cut_versions.append(cuts_zllcr_alljet)

    cuts_zllcr_lf = list()
    cuts_zllcr_lf.append(("ZllLFCR BB", "Cut0TagZllLFCRBB"))
    cuts_zllcr_lf.append(("ZllLFCR BC", "Cut0TagZllLFCRBC"))
    cuts_zllcr_lf.append(("ZllLFCR BL", "Cut0TagZllLFCRBL"))
    cuts_zllcr_lf.append(("ZllLFCR CC", "Cut0TagZllLFCRCC"))
    cuts_zllcr_lf.append(("ZllLFCR CL", "Cut0TagZllLFCRCL"))
    cuts_zllcr_lf.append(("ZllLFCR LL", "Cut0TagZllLFCRLL"))
    cuts_zllcr_lf.append(("ZllLFCR B0", "Cut0TagZllLFCRB0"))
    cuts_zllcr_lf.append(("ZllLFCR C0", "Cut0TagZllLFCRC0"))
    cuts_zllcr_lf.append(("ZllLFCR L0", "Cut0TagZllLFCRL0"))
    cuts_zllcr_lf.append(("ZllLFCR 00", "Cut0TagZllLFCR00"))
    cuts_zllcr_lf.append(("ZllLFCR Total", "Cut0TagZllLFCR"))
    cut_versions.append(cuts_zllcr_lf)

    for version in ["raw", "weighted"]:
        raw_counts = version == "raw"
        output_dir = "results/cutflow_zjets_composition_{:s}".format(version)
