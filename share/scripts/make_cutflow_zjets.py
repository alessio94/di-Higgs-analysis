...
def main(args):
    ...
    processes = list()
    processes.append((r"$Z\rightarrow{}ee$ (2.2.1)", "/bkg/{channel}/{campaign}/Zee/main"))
    processes.append((r"$Z\rightarrow{}ee$ (2.2.11)", "/oth/{channel}/{campaign}/Sh2211/Zjets/ee"))
    processes.append((r"$Z\rightarrow{}\mu\mu$ (2.2.1)", "/bkg/{channel}/{campaign}/Zmm/main"))
    processes.append((r"$Z\rightarrow{}\mu\mu$ (2.2.11)", "/oth/{channel}/{campaign}/Sh2211/Zjets/mm"))
    processes.append((r"$Z\rightarrow{}\tau\tau$ (2.2.1)", "/bkg/{channel}/{campaign}/Ztt/main"))
    processes.append((r"$Z\rightarrow{}\tau\tau$ (2.2.11)", "/oth/{channel}/{campaign}/Sh2211/Zjets/tautau"))
    ...
    for version in ["raw", "weighted"]:
        ...
        output_dir = "results/cutflow_zjets_{:s}".format(version)
...
if __name__ == "__main__":
    PARSER = argparse.ArgumentParser(
        description="Create cutflow table with comparison between Sherpa 2.2.1 and 2.2.11 samples"
    )
