...
def main(args):
    ...
    processes = list()
    processes.append((r"$Z\to{}ee$", "/oth/{channel}/{campaign}/Sh2211/Zjets/ee"))
    processes.append((r"$Z\to{}\mu\mu$", "/oth/{channel}/{campaign}/Sh2211/Zjets/mm"))
    processes.append((r"$Z\to{}\tau\tau$", "/oth/{channel}/{campaign}/Sh2211/Zjets/tautau"))
    processes.append((r"$Z\to{}\nu\nu$", "/oth/{channel}/{campaign}/Sh2211/Zjets/nunu"))
    processes.append((r"$W\to{}e\nu$", "/oth/{channel}/{campaign}/Sh2211/Wjets/enu"))
    processes.append((r"$W\to{}\mu\nu$", "/oth/{channel}/{campaign}/Sh2211/Wjets/munu"))
    processes.append((r"$W\to{}\tau\nu$", "/oth/{channel}/{campaign}/Sh2211/Wjets/taunu"))
    ...
    for version in ["raw", "weighted"]:
        ...
        output_dir = "results/cutflow_sherpa2211_{:s}".format(version)
...
if __name__ == "__main__":
    PARSER = argparse.ArgumentParser(description="Create cutflow table with breakdown for Sherpa 2.2.11 samples")
