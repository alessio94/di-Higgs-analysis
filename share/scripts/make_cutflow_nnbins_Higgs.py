...
def main(args):
    ...
    processes = list()
    processes.append((r"Total SM bkg.", "/bkg/{channel}/{campaign}/prompt"))
    processes.append((r"Higgs", "/bkg/{channel}/{campaign}/prompt/Higgs"))
    processes.append((r"ggF $H\to{}\tau\tau$", "/bkg/{channel}/{campaign}/prompt/Higgs/tautau/ggf"))
    processes.append((r"VBF $H\to{}\tau\tau$", "/bkg/{channel}/{campaign}/prompt/Higgs/tautau/vbf"))
    processes.append((r"VH $H\to{}\tau\tau$", "/bkg/{channel}/{campaign}/prompt/Higgs/tautau/vh"))
    processes.append((r"ggF $H\to{}WW$", "/bkg/{channel}/{campaign}/prompt/Higgs/WW/ggf"))
    processes.append((r"VBF $H\to{}WW$", "/bkg/{channel}/{campaign}/prompt/Higgs/WW/vbf"))
    processes.append((r"VH $H\to{}WW$", "/bkg/{channel}/{campaign}/prompt/Higgs/WW/vh"))
    processes.append((r"ggF $H\to{}ZZ$", "/bkg/{channel}/{campaign}/prompt/Higgs/ZZ/ggf"))
    processes.append((r"VBF $H\to{}ZZ$", "/bkg/{channel}/{campaign}/prompt/Higgs/ZZ/vbf"))
    processes.append((r"ggF $H\to{}bb$", "/bkg/{channel}/{campaign}/prompt/Higgs/bb/ggf"))
    processes.append((r"VBF $H\to{}bb$", "/bkg/{channel}/{campaign}/prompt/Higgs/bb/vbf"))
    processes.append((r"VH $H\to{}bb$", "/bkg/{channel}/{campaign}/prompt/Higgs/bb/vh"))
    processes.append((r"VH $H\to{}cc$", "/bkg/{channel}/{campaign}/prompt/Higgs/cc/vh"))
    processes.append((r"VH (inclusive)", "/oth/{channel}/{campaign}/bkg/prompt/Higgs/vh"))
    processes.append((r"VH (individual)", "/bkg/{channel}/{campaign}/prompt/Higgs/?/vh"))
    processes.append((r"ttH", "/bkg/{channel}/{campaign}/prompt/Higgs/ttH"))
    ...
    for version in ["raw", "weighted"]:
        ...
        output_dir = "results/cutflow_nnbins_Higgs_{:s}".format(version)
