...
def main(args):
    ...
    processes = list()
    processes.append((r"$t\overline{t}$", "/bkg/{channel}/{campaign}/top/ttbar"))
    processes.append((r"$Wt$", "/bkg/{channel}/{campaign}/top/stop"))
    processes.append((r"$t\overline{t}+V (W,Z)$", "/bkg/{channel}/{campaign}/top/ttbarV/[W+Z]"))
    processes.append((r"$t\overline{t}+V (ee)$", "/bkg/{channel}/{campaign}/top/ttbarV/ee"))
    processes.append((r"$t\overline{t}+V (\mu\mu)$", "/bkg/{channel}/{campaign}/top/ttbarV/mm"))
    processes.append((r"$t\overline{t}+V (\tau\tau)$", "/bkg/{channel}/{campaign}/top/ttbarV/tautau"))
    processes.append((r"Top (all)", "/bkg/{channel}/{campaign}/top"))
    ...
    for version in ["raw", "weighted"]:
        ...
        output_dir = "results/cutflow_top_{:s}".format(version)
...
if __name__ == "__main__":
    PARSER = argparse.ArgumentParser(description="Create cutflow table with breakdown for top samples")
