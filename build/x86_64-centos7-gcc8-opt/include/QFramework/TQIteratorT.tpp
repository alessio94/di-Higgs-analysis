...
template<class T>
const TCollection* TQIteratorT<T>::getCollection() const {
...
template<class T>
void TQIteratorT<T>::setCollection(const TCollection* c, bool ownCollection){
  // set the collection in this iterator
  this->clear();
  this->fCollection = const_cast<TCollection*>(c);
...
template<class T>
TQIteratorT<T>::TQIteratorT(const TCollection * c, bool ownCollection): 
  fOwnsCollection(ownCollection),
  fOwnsIterator(c),
  fCollection(const_cast<TCollection*>(c)),
...
template<class T>
TQIteratorT<T>::TQIteratorT(const TCollection * c, const TString& filter, bool ownCollection):
  fOwnsCollection(ownCollection),
  fOwnsIterator(c),
  fCollection(const_cast<TCollection*>(c)),
  fIterator(c ? c->MakeIterator() : NULL),
...
template<class T>
inline T* TQIteratorT<T>::cast(TObject* obj) const {
...
template< >
inline TObject* TQIteratorT<TObject>::cast(TObject* obj) const {
...
template<class T>
bool TQIteratorT<T>::hasNext() const {
