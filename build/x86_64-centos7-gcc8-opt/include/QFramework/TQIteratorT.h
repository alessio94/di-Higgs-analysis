...
protected:
  ...
  const TCollection * fCollection = NULL;
...
public:
  ...
  TQIteratorT(const TCollection * c, bool ownCollection = false);
  TQIteratorT(const TCollection * c, const TString& filter, bool ownCollection = false);

  const TCollection* getCollection() const;
  void setCollection(const TCollection* c, bool ownCollection = false);
  void clear();
  
  bool hasNext() const;
  T * getNext() const;
  T * readNext();
  T * cast(TObject* obj) const;
