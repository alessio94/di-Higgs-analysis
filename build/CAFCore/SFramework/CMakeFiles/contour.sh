...
#
# This script is used by CTest to run the test contour with the correct
...
export ATLAS_CTEST_PACKAGE=SFramework

# Run a possible pre-exec script:
# No pre-exec necessary

# Run the test:
/afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/build/CAFCore/SFramework/test-bin/contour.exe 2>&1 | tee contour.log; \
...
if [ -f /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/CAFCore/SFramework/share/contour.ref ] &&
    [ "/afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/CAFCore/SFramework" != "/afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/build/CAFCore/SFramework" ]; then
    ...
    /cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.18.3/Linux-x86_64/bin/cmake -E create_symlink \
     /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/CAFCore/SFramework/share/contour.ref ../share/contour.ref
fi
