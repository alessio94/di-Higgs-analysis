...
#
# This script is used by CTest to run the test TQCut with the correct
...
# Run the test:
/afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/build/CAFCore/QFramework/test-bin/TQCut.exe 2>&1 | tee TQCut.log; \
...
if [ -f /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/CAFCore/QFramework/share/TQCut.ref ] &&
    ...
    /cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.18.3/Linux-x86_64/bin/cmake -E create_symlink \
     /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/CAFCore/QFramework/share/TQCut.ref ../share/TQCut.ref
fi
