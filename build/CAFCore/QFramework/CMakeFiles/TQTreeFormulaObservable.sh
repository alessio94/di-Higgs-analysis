...
#
# This script is used by CTest to run the test TQTreeFormulaObservable with the correct
...
# Run the test:
/afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/build/CAFCore/QFramework/test-bin/TQTreeFormulaObservable.exe 2>&1 | tee TQTreeFormulaObservable.log; \
...
if [ -f /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/CAFCore/QFramework/share/TQTreeFormulaObservable.ref ] &&
    ...
    /cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.18.3/Linux-x86_64/bin/cmake -E create_symlink \
     /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/CAFCore/QFramework/share/TQTreeFormulaObservable.ref ../share/TQTreeFormulaObservable.ref
fi

# Run a post-exec script:
if type post.sh >/dev/null 2>&1; then
    post.sh TQTreeFormulaObservable ""
fi
