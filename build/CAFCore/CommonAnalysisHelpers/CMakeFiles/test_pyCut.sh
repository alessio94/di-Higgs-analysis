...
#
# This script is used by CTest to run the test test_pyCut with the correct
...
# Run the test:
/afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/build/CAFCore/CommonAnalysisHelpers/test-bin/test_pyCut.exe 2>&1 | tee test_pyCut.log; \
...
if [ -f /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/CAFCore/CommonAnalysisHelpers/share/test_pyCut.ref ] &&
    ...
    /cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.18.3/Linux-x86_64/bin/cmake -E create_symlink \
     /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/CAFCore/CommonAnalysisHelpers/share/test_pyCut.ref ../share/test_pyCut.ref
fi
