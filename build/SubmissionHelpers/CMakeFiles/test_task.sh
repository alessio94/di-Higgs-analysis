...
#
# This script is used by CTest to run the test test_task with the correct
...
# Run the test:
/afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/build/SubmissionHelpers/test-bin/test_task.exe 2>&1 | tee test_task.log; \
...
if [ -f /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/SubmissionHelpers/share/test_task.ref ] &&
    ...
    /cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.18.3/Linux-x86_64/bin/cmake -E create_symlink \
     /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/SubmissionHelpers/share/test_task.ref ../share/test_task.ref
fi
