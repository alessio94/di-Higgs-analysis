...
#
# This script is used by CTest to run the test test_local_controller with the correct
...
# Run the test:
/afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/build/SubmissionHelpers/test-bin/test_local_controller.exe 2>&1 | tee test_local_controller.log; \
...
if [ -f /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/SubmissionHelpers/share/test_local_controller.ref ] &&
    ...
    /cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.18.3/Linux-x86_64/bin/cmake -E create_symlink \
     /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/SubmissionHelpers/share/test_local_controller.ref ../share/test_local_controller.ref
fi

# Run a post-exec script:
if type post.sh >/dev/null 2>&1; then
    post.sh test_local_controller ""
fi
