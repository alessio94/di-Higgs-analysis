...
set( CTEST_SOURCE_DIRECTORY /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll )
set( CTEST_BINARY_DIRECTORY /afs/cern.ch/work/a/apizzini/private/2022/nov/CAFbbll/build )

set( CTEST_CUSTOM_MAXIMUM_NUMBER_OF_ERRORS   1000000 )
set( CTEST_CUSTOM_MAXIMUM_NUMBER_OF_WARNINGS 1000000 )

set( CTEST_COMMAND "/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.18.3/Linux-x86_64/bin/ctest -D Nightly" )
set( CTEST_CMAKE_COMMAND /cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.18.3/Linux-x86_64/bin/cmake )
...
set( CTEST_SITE lxplus754.cern.ch )

# Start a nightly build:
message( "Starting nightly build for project CAFbbll..." )
ctest_start( Nightly )
...
find_file( _buildExtractor NAMES extractCTestBuild.py
   PATH_SUFFIXES scripts PATHS /cvmfs/atlas.cern.ch/repo/sw/software/21.2/AnalysisBase/21.2.174/InstallArea/x86_64-centos7-gcc8-opt/cmake/modules;/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AnalysisBaseExternals/21.2.174/InstallArea/x86_64-centos7-gcc8-opt/cmake/modules )
...
set( _subprojects QFramework;AtlasEigen;AsgTools;xAODCore;xAODParticleEvent;xAODTruth;xAODEventInfo;AsgAnalysisInterfaces;CAFxAODUtils;CAFCore;CommonAnalysisHelpers;AssociationUtils;PATInterfaces;CxAODUtils;SFramework;CAFlwtnn;xAODBase;xAODMissingET;CalcGenericMT2;CxAODTools;SubmissionHelpers;PathResolver;TTbarNNLOReweighter;hhTruthWeightTools )
